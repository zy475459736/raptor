...
public final class ErrorProto {
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected FieldAccessorTable
      ...
      return ErrorProto.internal_static_com_ppdai_framework_raptor_exception_ErrorMessage_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              ErrorProto.ErrorMessage.class, ErrorProto.ErrorMessage.Builder.class);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof ErrorProto.ErrorMessage)) {
        return super.equals(obj);
      }
      ErrorProto.ErrorMessage other = (ErrorProto.ErrorMessage) obj;
    ...
    public static ErrorProto.ErrorMessage parseFrom(
    ...
    public static ErrorProto.ErrorMessage parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static ErrorProto.ErrorMessage parseFrom(
    ...
    public static ErrorProto.ErrorMessage parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static ErrorProto.ErrorMessage parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static ErrorProto.ErrorMessage parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(ErrorProto.ErrorMessage prototype) {
    ...
    public static final class Builder extends
        ...
        ErrorProto.ErrorMessageOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return ErrorProto.internal_static_com_ppdai_framework_raptor_exception_ErrorMessage_descriptor;
      }
      ...
      public ErrorProto.ErrorMessage getDefaultInstanceForType() {
        return ErrorProto.ErrorMessage.getDefaultInstance();
      }

      public ErrorProto.ErrorMessage build() {
        ErrorProto.ErrorMessage result = buildPartial();
      ...
      public ErrorProto.ErrorMessage buildPartial() {
        ErrorProto.ErrorMessage result = new ErrorProto.ErrorMessage(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof ErrorProto.ErrorMessage) {
          return mergeFrom((ErrorProto.ErrorMessage)other);
        } else {
      ...
      public Builder mergeFrom(ErrorProto.ErrorMessage other) {
        if (other == ErrorProto.ErrorMessage.getDefaultInstance()) return this;
        if (other.getCode() != 0) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        ErrorProto.ErrorMessage parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (ErrorProto.ErrorMessage) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final ErrorProto.ErrorMessage DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new ErrorProto.ErrorMessage();
    }

    public static ErrorProto.ErrorMessage getDefaultInstance() {
