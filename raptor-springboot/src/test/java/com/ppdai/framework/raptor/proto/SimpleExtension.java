...
public interface SimpleExtension {
    ...
    @RequestMapping("/get1")
    AllTypesPojo testGet1(AllTypesPojo request, @RequestParam("p1") String p1);
    ...
    AllTypesPojo testPost1(AllTypesPojo request, @RequestParam("p1") String p1);
    ...
    AllTypesPojo testPut1(AllTypesPojo request, @RequestParam("p1") String p1);
